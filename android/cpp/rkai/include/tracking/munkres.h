...
public:
     ...
     *
     */
    void solve(TrackingMatrix<Data> &m) {
    ...
    static void replace_infinites(TrackingMatrix<Data> &matrix) {
    ...
    static void minimize_along_direction(TrackingMatrix<Data> &matrix, const bool over_columns) {
...
private:
  ...
  TrackingMatrix<int> mask_matrix;
  TrackingMatrix<Data> matrix;
  bool *row_mask;
  bool *col_mask;
